import type { BlackMarketNegotiationStrategy } from '@shared/lib/blackMarketRules';
import type {
  BlackMarketNpcId,
...
export interface BlackMarketNpcConfig extends Omit<
  ...
  'status'
> {
  preferredStrategies: readonly BlackMarketNegotiationStrategy[];
  voice: string;
  opening: string;
  epilogue: string;
}
...
export const BLACK_MARKET_NPCS: readonly BlackMarketNpcConfig[] = [
  {
    ...
    name: '笑面掌柜',
    identity: '暗巷掮客',
    responsibility: '话里藏针，最爱拿人情做买卖',
    preferredStrategies: ['relationship', 'bluff'],
  ...
  },
  {
    ...
    name: '沉默老者',
    identity: '旧物鉴家',
    responsibility: '只认眼力与证据，不耐无端压价',
    preferredStrategies: ['reason'],
    voice: '寡言、克制、专业，惜字如金',
  ...
  },
  {
    ...
    name: '急售散修',
    identity: '亡命货主',
    responsibility: '来去匆匆，愿听干脆的价钱',
    preferredStrategies: ['direct_offer', 'pressure'],
