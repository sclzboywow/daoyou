...
import contentSafetyRouter from '@server/routes/api/content-safety.router';
...
import rewardedAdCallbackRouter from '@server/routes/api/rewarded-ad-callback.router';
import wechatMessagePushRouter from '@server/routes/api/wechat-message-push.router';
...
apiRouter.route('/wechat/rewarded-ad-callback', rewardedAdCallbackRouter);
